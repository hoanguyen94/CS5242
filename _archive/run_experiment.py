...
def make_loaders(ds, train_tf, eval_tf, batch_size: int = 256, num_workers: int = 8):
...
def classical_ml_experiment(ds, eval_tf, device, backbone="convnext_tiny", clf_type="logreg", batch_size=256, save_dir=Path("./outputs"), img_size=224):
    ...
    train_loader, val_loader, test_loader = make_loaders(ds, eval_tf, eval_tf, batch_size=batch_size, num_workers=8)
